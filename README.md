...
Angular dropdown component for web applications. Easy to integrate and use.
...
You can create your own theme from now on. You can have a look at example scss theming file at src/themes/default.theme.scss
